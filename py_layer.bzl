...
# e.g. this will match
#   `/[package]/[package]_bin.runfiles/rules_python~0.21.0~python~python3_9_aarch64-unknown-linux-gnu/bin/python3`
# but not match
#   `/[package]/[package]_bin.runfiles/_main/python_app`
